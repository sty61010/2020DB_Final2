...
public class Calvin extends VanillaDb {
	...
	public static Map<PrimaryKey, InMemoryRecord> BatchUpdateMap = new ConcurrentHashMap<PrimaryKey, InMemoryRecord>();
	public static Map<PrimaryKey, Map<String, Constant>> BatchInsertMap = new ConcurrentHashMap<PrimaryKey, Map<String, Constant>>();
